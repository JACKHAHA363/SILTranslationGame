...
jobname = "run_180615_rerun_rnn"
mem = 24
hours = 12
slurm_dir = home_dir + "180615_rerun_rnn" if not args.interactive else ""
if not args.interactive and not os.path.exists(slurm_dir):
    os.mkdir(slurm_dir)
event_path = "event_180615_rerun_rnn"
model_path = "model_180615_rerun_rnn"
log_path = "log_180615_rerun_rnn"
decoding_path = "decoding_180615_rerun_rnn"
...
for pair in pairs: # 2
    for drop_ratio in drop_ratios: # 4
        for lr in lrs: # 3 
            for (lr_anneal, linear_steps) in lr_anneals: # 1
                job_idx += 1
