...
jobname = "180611_rewards"
mem = 16
hours = 24
slurm_dir = home_dir + "180611_rewards" if not interactive else ""
if not interactive and not os.path.exists(slurm_dir):
    os.mkdir(slurm_dir)
event_path = "event_180611_rewards"
model_path = "model_180611_rewards"
log_path = "log_180611_rewards"
decoding_path = "decoding_180611_rewards"
