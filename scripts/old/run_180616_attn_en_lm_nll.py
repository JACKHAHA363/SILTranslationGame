...
jobname = "180616_attn_en_lm_nll"
mem = 20
hours = 36
slurm_dir = home_dir + "180616_attn_en_lm_nll" if not args.interactive else ""
if not args.interactive and not os.path.exists(slurm_dir):
    os.mkdir(slurm_dir)
event_path = "event_180616_attn_en_lm_nll"
model_path = "model_180616_attn_en_lm_nll"
log_path = "log_180616_attn_en_lm_nll"
decoding_path = "decoding_180616_attn_en_lm_nll"
