...
jobname = "180612_cpt_alpha"
mem = 16
hours = 24
slurm_dir = home_dir + "180612_cpt_alpha" if not args.interactive else ""
if not args.interactive and not os.path.exists(slurm_dir):
    os.mkdir(slurm_dir)
event_path = "event_180612_cpt_alpha"
model_path = "model_180612_cpt_alpha"
log_path = "log_180612_cpt_alpha"
decoding_path = "decoding_180612_cpt_alpha"
